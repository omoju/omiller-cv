...
\documentclass[10.5pt,article,oneside]{memoir}  
\usepackage{geometry}
 \geometry{
 a4paper,
 total={170mm,257mm},
...
%% Name 
\noindent{\HUGE\scheader \textsc{\href{https://github.com/omoju}{omoju thomas miller}}}
...
\ind {\large \textbf{ICSI} - \textit{Graduate Researcher}} \hfill Berkeley, CA | Mar 2011-Dec 2012
\begin{itemize}[noitemsep,nolistsep]
...
\ind {\large \textbf{UniversityNow} - \textit{Semantic Data Scientist (Intern)}} \hfill San Francisco, CA | Jun 2012 -Aug 2012
\begin{itemize}[noitemsep,nolistsep]
