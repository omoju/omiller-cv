...
\setmonofont[Mapping=tex-text,Scale=1]{Consolas}
...
\begin{itemize}[nolistsep]
\item[-]Contributed to the development of an AI assisted eLearning workforce development system.
...
\begin{itemize}[nolistsep]
\item[-] Provides strategy around product market fit, and data.
\end{itemize}  
