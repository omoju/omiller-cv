...
\item[-] Created supervised learning model to classify students needing intervention. Implemented using Jupyter notebooks, with Scikit-learn, Pandas and Numpy python packages.
...
\item[-] Project was implemented on edX MOOClet, BJC.3x: Data, Information and the Internet.
\item[-] Curricula unit had a significant positive effect on the experience of ethnic-minority students in the class.
\end{itemize} 
