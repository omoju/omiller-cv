...
\ind \href{https://github.com/omoju/studentIntervention}{Student Intervention}
...
\ind \href{https://github.com/omoju/investigatingWhyURMsChooseCS}{Investigating Why Historically Underrepresented Students Choose CS}
\begin{itemize}[noitemsep,nolistsep]
\item[-] 
\end{itemize} 

\ind \href{https://github.com/omoju/DissertationDataAnalysis}{Classifying Undergraduate Intro CS by Gender}
\begin{itemize}[noitemsep,nolistsep]
\item[-] 
\end{itemize} 

\ind \href{https://github.com/omoju/BostonHousingPrediction}{Boston Housing Prediction}
\begin{itemize}[noitemsep,nolistsep]
\item[-] 
\end{itemize} 
...
\begin{itemize}[noitemsep,nolistsep]
\item[-]Founded Advisory Board
\item[-]Worked with CEO to identify ...
\end{itemize} 

\ind Google, Technology Portfolio Manager, San Francisco, CA, Feb 2014 - December 2015. 
\begin{itemize}[noitemsep,nolistsep]
\item[-]CSEd Specialist, co-leading non-profit investment in Computer Science Education, helping entrepreneurs launch new solutions to old problems at scale.
\end{itemize} 
